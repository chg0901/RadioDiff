#!/usr/bin/env python3
"""
Improved visualization of RadioDiff VAE training log with proper y-axis scaling (non-interactive).
"""
...
def create_improved_visualizations(df, output_dir='radiodiff_Vae'):
    ...
    plt.close(fig)
    print("  Saved: multi_axis_losses.png")
...
def main():
    ...
    print("\n=== Training Statistics ===")
    metrics_to_analyze = ['train/total_loss', 'train/kl_loss', 'train/rec_loss', 'train/g_loss']
